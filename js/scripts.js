...
let mQuadrado = 16;
console.log (`A raiz quadrada do número ${mQuadrado} é ${raizQuadrada(mQuadrado)} !`);
...
const multiplicacao = (n2, multiplicador = 2) => {
    ...
    console.log(`Pirimeiro parâmetro ${n2}, segundo parâmetro ${multiplicador}, a multiplicação é ${resultado2} `);
}
    multiplicacao (2,3);
    multiplicacao (2);

// const loopRaizQualquer = (n,m=2) => {
//     let xresultado = Math.round(n/m); 
//     console.log(xresultado);
//     while (xresultado < 6) {
//         xresultado++;
//         console.log ((`Pirimeiro parâmetro ${n}, segundo parâmetro ${m}, a raiz ${m} é ${n/m} `));
//     }
// }

// loopRaizQualquer (36,2);

let xresultado = Math.round (2/2);
console.log (xresultado);